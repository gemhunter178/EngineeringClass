...
void Person::printPersonInfo() {
	...
	std::cout << std::left << std::setw(16) << fullname << std::setw(16) << address << std::setw(8) << age;
	//return
	return;
}
...
void Student::printStudentInfo() {
	...
	std::cout << std::left << std::setw(16) << ID << std::flush;
	std::cout << std::left << std::setw(8) << major << std::flush;
	std::cout << std::left << std::setw(8) << gpa << std::flush;
}
